...
export const featuresData: IFeature[] = [
    ...
    },
    {
        ...
        description: "Generate vibrants, high-contrast thumnails that stand out in the feed.",
    },
    {
        icon: "/assets/shape-icon.svg",
        title: "Fully Editable",
        description: "Get fully layered designs you can tweak to perfecton if needed.",
    },
];